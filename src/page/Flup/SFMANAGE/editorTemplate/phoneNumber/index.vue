<template>
      <div class="user-name" :style="basicStyle" @click="btnHidden">
                    <span class="user-text" @mousedown.prevent="move($event, currentIndex)" :style="nameStyle">手机</span>
                    <div class="inp-box">
                       <input type="text" placeholder="请输入手机号码" class="user-inp" :style="inputStyle">
                    </div>
