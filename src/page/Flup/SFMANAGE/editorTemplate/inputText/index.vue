<template>
      <div class="user-name" :style="basicStyle" @click="btnHidden">
                    <span class="user-text" @mousedown.prevent="move($event, currentIndex)" :style="nameStyle">姓名</span>
                    <div class="inp-box">
                       <input type="text" placeholder="请输入姓名" class="user-inp" :style="inputStyle">
                    </div>
